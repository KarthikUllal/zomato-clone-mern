...
import OrderStatusPieCharts from "../charts/OrderStatusPieCharts";
    ...
    <div className="dashboard-wrapper">
      ...
      <div className="analysis-grid">
        <div className="analysis-card">
          <h2>Revenue Trend Analysis (Last 7 Days)</h2>
          <div className="line-chart-container">
            <RevenueTrendChart orders={orderList} />
          </div>
        </div>
        <div className="analysis-card">
        ...
        <div className="analysis-card">
          <h2>Monthly Orders Analysis</h2>
          <MonthlyOrdersChart orders={orderList} />
        </div>
        <div className="analysis-card">
          <h2>Orders Trend Analysis (Last 7 Days)</h2>
          <OrdersTrendChart orders={orderList} />
        </div>
      </div>
